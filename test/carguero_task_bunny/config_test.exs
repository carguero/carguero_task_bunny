defmodule CargueroTaskBunny.ConfigTest do
  use ExUnit.Case, async: false
  alias CargueroTaskBunny.Config
  ...
  setup do
    ...
    :meck.expect(Application, :get_all_env, fn :carguero_task_bunny -> test_config() end)
  ...
  describe "publisher_pool_size" do
    test "returns the pool size for the publisher if it has been configured for the application" do
      :meck.expect(Application, :get_env, fn :carguero_task_bunny, :publisher_pool_size, 15 -> 5 end)
  ...
  describe "publisher_max_overflow" do
    test "returns the max overflow for the publisher if is configured for the application" do
      :meck.expect(Application, :get_env, fn :carguero_task_bunny, :publisher_max_overflow, 0 -> 5 end)
