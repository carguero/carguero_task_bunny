defmodule CargueroTaskBunny.FailureBackendTest do
  use ExUnit.Case, async: false
  alias CargueroTaskBunny.{JobError, FailureBackend}
  import ExUnit.{CaptureLog, CaptureIO}

  defp setup_failure_backend_config(failure_backend) do
    :meck.new(Application, [:passthrough])

    :meck.expect(Application, :fetch_env, fn :carguero_task_bunny, :failure_backend ->
      {:ok, failure_backend}
    end)
