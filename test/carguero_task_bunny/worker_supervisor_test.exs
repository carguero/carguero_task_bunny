defmodule CargueroTaskBunny.WorkerSupervisorTest do
  use ExUnit.Case, async: false
  import CargueroTaskBunny.QueueTestHelper
  alias CargueroTaskBunny.{Config, Connection, Queue, WorkerSupervisor, JobTestHelper}
  alias JobTestHelper.TestJob

  @queue "carguero_task_bunny.worker_supervisor_test"
  @worker_name :"CargueroTaskBunny.Worker.#{@queue}"
