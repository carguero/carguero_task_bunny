defmodule CargueroTaskBunny.SupervisorTest do
  use ExUnit.Case, async: false
  import CargueroTaskBunny.QueueTestHelper
  alias CargueroTaskBunny.{Config, Connection, Queue, JobTestHelper}
  alias JobTestHelper.TestJob

  @host :sv_test
  @queue "carguero_task_bunny.supervisor_test"
  ...
  setup do
    ...
    CargueroTaskBunny.Supervisor.start_link(:supevisor_test, :wsv_supervisor_test, :ps_supervisor_test)
  ...
  describe "AMQP connection is lost" do
    test "recovers by restarting connection and all workers" do
      conn_name = :"CargueroTaskBunny.Connection.#{@host}"
      work_name = :"CargueroTaskBunny.Worker.#{@queue}"
