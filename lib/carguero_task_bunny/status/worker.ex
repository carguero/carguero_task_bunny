defmodule CargueroTaskBunny.Status.Worker do
  @moduledoc false
  ...
  """
  @spec get({any, pid, atom, list}) :: CargueroTaskBunny.Status.Worker.t()
  def get({_name, pid, _atom, _list}) do
    get(pid)
  end

  @spec get(pid) :: CargueroTaskBunny.Status.Worker.t()
  def get(pid) do
