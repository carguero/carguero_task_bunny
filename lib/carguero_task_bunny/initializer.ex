defmodule CargueroTaskBunny.Initializer do
  # Handles initialization concerns.
  #
  # This module is private to CargueroTaskBunny and should not be accessed directly.
  #
  @moduledoc false
  use GenServer
  require Logger
  alias CargueroTaskBunny.{Config, Queue}
  ...
  @doc """
  Returns true if CargueroTaskBunny has been initialized
  """
  ...
  defp declare_queue(queue_config) do
    ...
    CargueroTaskBunny.Connection.subscribe_connection(host, self())
    ...
    after
      2_000 ->
        Logger.warn("""
        CargueroTaskBunny.Initializer: Failed to get connection for #{host}.
        CargueroTaskBunny can't declare the queues but carries on.
        """)
    end
  ...
  defp declare_queue(conn, queue) do
    ...
    :exit, e ->
      ...
      Logger.warn("""
      CargueroTaskBunny.Initializer: Failed to declare queue for #{queue}.
