defmodule CargueroTaskBunny.ConfigError do
  @moduledoc """
  ...
  def exception(message: message) do
    title = "Failed to load CargueroTaskBunny config"
    message = "#{title}\n#{message}"
    %__MODULE__{message: message}
  end
end

defmodule CargueroTaskBunny.Connection.ConnectError do
  @moduledoc """
...
defmodule CargueroTaskBunny.Job.QueueNotFoundError do
  @moduledoc """
...
defmodule CargueroTaskBunny.Message.DecodeError do
  @moduledoc """
...
defmodule CargueroTaskBunny.Publisher.PublishError do
  @moduledoc """
