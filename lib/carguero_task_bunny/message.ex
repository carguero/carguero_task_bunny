defmodule CargueroTaskBunny.Message do
  @moduledoc """
  ...
  However in case you need to encode/decode CargueroTaskBunny messages,
  this module will help.
  """
  alias CargueroTaskBunny.Message.DecodeError
  ...
  def decode(message) do
    case Jason.decode(message) do
      ...
      error ->
        {:error, {:jason_decode_error, error}}
    end
  rescue
